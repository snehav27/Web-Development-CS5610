    ...
    $scope.getDetails = function () {
        ...
        $http.get(url).success(function (response) {
            ...
            if (carDetails[0] == null) {
                ...
                document.getElementById("displayMessage").innerHTML = "No Data Available, Please retry with another Car.";
            }
            else {
      ...
      error(function (data, status, headers, config) {
          document.getElementById("tab1").style.display = "none";
          document.getElementById("displayMessage").innerHTML = "Something went wrong . Please retry, with another Car.";
      });
    }
}
        ...
        $http.get(url).success(function (response) {
          ...
          //  alert($scope.car2);
            if (carImages[0].photoSrcs[0] == null) {
                ...
                document.getElementById("displayMessage2").innerHTML = "No Data Available, Please retry with another Car.";
            }
            else {
...
function CarInfoController3($scope, $http) {
    ...
    $scope.getDetails = function () {
        ...
        $http.get(url).success(function (response) {
           ...
           // alert(dealerDetails[0].address);
            if (dealerDetails[0] == null) {
                ...
                document.getElementById("displayMessage3").innerHTML = "No Data Available, Please Retry with another Zip Code.";
            }
            else {
      ...
      error(function (data, status, headers, config) {
          document.getElementById("tab3").style.display = "none";
          document.getElementById("displayMessage3").innerHTML = "Zip Code entered is wrong .Please Retry, with another Zip Code.";
      });
    }
}
...
function CarInfoController4($scope, $http) {
    ...
    $scope.getDetails = function () {
        ...
        $http.get(url).success(function (response) {
           ...
           // alert($scope.car.value);
            if ($scope.car.value == null) {
                ...
                document.getElementById("displayMessage4").innerHTML = "No Data Available, Please retry with another Car.";
            }
            else {
      ...
      error(function (data, status, headers, config) {
          document.getElementById("tab4").style.display = "none";
          document.getElementById("displayMessage4").innerHTML = "Zip Code entered is wrong .Please Retry with another Zip Code.";
      });
    }
}
    ...
    $scope.getDetails = function () {
        ...
        $http.get(url).success(function (response) {
            ...
            if (carequipmentdetails.equipmentCount == 0) {
                ...
                document.getElementById("displayMessage5").innerHTML = "No Data Available , Please retry with another Selection.";
            }
            else {
      ...
      error(function (data, status, headers, config) {
          document.getElementById("tab5").style.display = "none";
          document.getElementById("displayMessage5").innerHTML = "Something Went wrong, Please retry with another An Old Car.";
      });
    }
}
...
function yearValidation(year, ev) {
    ...
    if (ev.type == "blur" || year.length == 4 && ev.keyCode != 8 && ev.keyCode != 46) {
        if (year != 0) {
            ...
            var future_current_year = new Date().getFullYear() + 3;
            
            if ((year < 1990) || (year > future_current_year)) {
                alert("Year should be in range 1990 to current year or 3 future years");
                return false;
            }
            return true;
        }
